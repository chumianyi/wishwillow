...
class NeumorphismEditText @JvmOverloads constructor(c: Context, a: AttributeSet?=null, s: Int=0):AppCompatEditText(c,a,s){
    ...
    init{setBackgroundColor(Color.TRANSPARENT);setPadding(40,32,40,32);setTextColor(Color.parseColor("#2D3748"));setHintTextColor(Color.parseColor("#718096"));textSize=16f;background=null;isFocusable=true;isFocusableInTouchMode=true;isClickable=true;isCursorVisible=true}
